...
export default function Home() {
  ...
  // Loading inicial de verificação de autenticação
  if (loadingAuth) {
    return (
  ...
  // =========================================================================
  // 1. TELA DE LOGIN IDÊNTICA AO DESIGN DA AVJURIS
  // =========================================================================
  if (!user) {
    return (
        ...
        <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col items-center text-center px-4 sm:px-8">
            ...
            <button
              ...
              type="button"
              className="w-full flex items-center justify-center space-x-3 py-2.5 px-4 border border-slate-200 rounded-xl bg-white hover:bg-slate-50 text-sm font-semibold text-slate-700 shadow-sm transition-all mb-4"
            >
            ...
            <form onSubmit={handleEmailAuth} className="w-full space-y-4 text-left">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 text-sm bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:bg-white"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full p-2.5 text-sm bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:bg-white pr-10"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="w-full py-3 bg-[#1e3a8a] hover:bg-blue-900 text-white rounded-lg font-bold text-sm shadow-md transition-all flex items-center justify-center space-x-2"
              >
                {authLoading ? (
          ...
          {/* LADO DIREITO: CARD INSTITUCIONAL AZUL ESCURO */}
          <div className="bg-[#0b132b] text-white p-8 sm:p-10 rounded-3xl shadow-2xl flex flex-col justify-between min-h-[480px]">
            <div>
              <div className="flex items-center space-x-2 text-xs font-bold tracking-widest text-[#38bdf8] uppercase mb-8">
            ...
            <div className="bg-[#0f172a]/90 border border-white/10 rounded-2xl p-6">
              <span className="text-2xl text-[#38bdf8] leading-none block mb-2 font-serif">“</span>
              <p className="text-xs text-slate-300 leading-relaxed italic mb-4">
                A AvJuris IA revolucionou a forma como conduzimos nosso trabalho no escritório. Com a capacidade de pesquisar jurisprudência real e emitir atas e peças detalhadas, conseguimos otimizar nosso tempo e blindar nosso faturamento.
              </p>
              <div className="flex items-center space-x-3">
                <div className="w-9 h-9 rounded-full bg-[#38bdf8] text-[#0b132b] font-bold text-xs flex items-center justify-center">
                  MC
                </div>
                <div>
                  <h4 className="text-xs font-bold text-white">Mariana Costa</h4>
                  <p className="text-[10px] text-slate-400">Advogada Sênior</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg text-xs font-medium transition"
